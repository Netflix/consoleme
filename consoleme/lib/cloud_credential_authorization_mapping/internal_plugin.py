...
class InternalPluginAuthorizationMappingGenerator(CredentialAuthzMappingGenerator):
    async def generate_credential_authorization_mapping(
            self, authorization_mapping: Dict[user_or_group, RoleAuthorizations]) -> Dict[user_or_group, RoleAuthorizations]:
        ...
        authorization_mapping = await group_mapping.generate_credential_authorization_mapping(authorization_mapping)
        # Return mapping

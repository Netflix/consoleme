...
async def apply_changes_to_role(
    ...
    """
    # TODO: Assign variable principal and substitute it in all of the comments
    # TODO: raise exceptions on all conditions for invalid principals?
    # TODO: Expose errors better on policy review page
    # TODO: Modify policy table to make IAM users clickable and take users to policies page
    # TODO: Review cloudtrail logic to ensure it captures IAM user errors / S3 messages
    log_data: dict = {
        "function": f"{__name__}.{sys._getframe().f_code.co_name}",
        "user": user,
        "request": extended_request.dict(),

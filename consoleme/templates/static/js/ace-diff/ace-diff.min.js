/*! Ace-diff | github.com/ace-diff/ace-diff 2.3.0*/
!(function (t, e) {
  "object" == typeof exports && "object" == typeof module
    ? (module.exports = e(require("brace")))
    : "function" == typeof define && define.amd
    ? define(["brace"], e)
    : "object" == typeof exports
    ? (exports.AceDiff = e(require("brace")))
    : (t.AceDiff = e(t.ace));
  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n) {
        ...
        return (
          ...
          r(n) &&
            ((v = !!n.leading),
            (h = (_ = "maxWait" in n) ? a(o(n.maxWait) || 0, e) : h),
    ...
    function (t, e, n) {
      ...
      function d(t) {
        ...
        null !== this.options.element)
          ? (this.options.element instanceof HTMLElement
              ? (this.el = this.options.element)
              : (this.el = document.body.querySelector(this.options.element)),
            this.el
              ? ((this.options.left.id = (0, l.default)(
                  this.el,
                  "acediff__left"
                )),
                (this.options.classes.gutterID = (0, l.default)(
                  this.el,
                  "acediff__gutter"
                )),
                (this.options.right.id = (0, l.default)(
                  this.el,
                  "acediff__right"
                )),
                (this.el.innerHTML =
                  '<div class="acediff__wrap">' + this.el.innerHTML + "</div>"),
                (this.editors = {
                  left: {
                ...
                this.editors.left.ace
                  .getSession()
                  .setMode(v(this, p.EDITOR_LEFT)),
                this.editors.right.ace
                  .getSession()
                  .setMode(v(this, p.EDITOR_RIGHT)),
                this.editors.left.ace.setReadOnly(!this.options.left.editable),
                this.editors.right.ace.setReadOnly(
                  !this.options.right.editable
                ),
                this.editors.left.ace.setTheme(_(this, p.EDITOR_LEFT)),
                this.editors.right.ace.setTheme(_(this, p.EDITOR_RIGHT)),
                this.editors.left.ace.setValue(
                  (0, f.default)(this.options.left.content),
                  -1
                ),
                this.editors.right.ace.setValue(
                  (0, f.default)(this.options.right.content),
                  -1
                ),
                (this.editors.editorHeight =
                  ((e = this),
                  document.getElementById(e.options.left.id).offsetHeight)),
                setTimeout(function () {
                  var t;
                  (n.lineHeight = n.editors.left.ace.renderer.lineHeight),
                    (function (t) {
                      t.editors.left.ace.getSession().on(
                        "changeScrollTop",
                        (0, s.default)(function (e) {
                          L(t, "left", e);
                        }, 16)
                      ),
                        t.editors.right.ace.getSession().on(
                          "changeScrollTop",
                          (0, s.default)(function (e) {
                            L(t, "right", e);
                          }, 16)
                      ...
                      t.editors.left.ace.on("change", e),
                        ...
                        t.options.left.copyLinkEnabled &&
                          h.default.on(
                            "#" + t.options.classes.gutterID,
                            "click",
                            "." + t.options.classes.newCodeConnectorLink,
                            function (e) {
                              y(t, e, p.LTR);
                            }
                          );
                      t.options.right.copyLinkEnabled &&
                        h.default.on(
                          "#" + t.options.classes.gutterID,
                          "click",
                          "." + t.options.classes.deletedCodeConnectorLink,
                          function (e) {
                            y(t, e, p.RTL);
                          }
                        );
                      var n = (0, o.default)(function () {
                        (t.editors.availableHeight = document.getElementById(
                          t.options.left.id
                        ).offsetHeight),
                          t.diff();
                      }, 250);
                    ...
                    ((t = n).copyRightContainer = document.createElement(
                      "div"
                    )),
                    t.copyRightContainer.setAttribute(
                      "class",
                      t.options.classes.copyRightContainer
                    ),
                    (t.copyLeftContainer = document.createElement("div")),
                    t.copyLeftContainer.setAttribute(
                      "class",
                      t.options.classes.copyLeftContainer
                    ),
                    document
                      .getElementById(t.options.classes.gutterID)
                      .appendChild(t.copyRightContainer),
                    document
                      .getElementById(t.options.classes.gutterID)
                      .appendChild(t.copyLeftContainer),
                    O(n),
                    n.diff();
                }, 1))
              : console.error(
                  "Can't find the specified element " + this.options.element
                ))
      ...
      function v(t, e) {
        ...
        return (
          e === p.EDITOR_LEFT &&
            null !== t.options.left.mode &&
            (n = t.options.left.mode),
          e === p.EDITOR_RIGHT &&
            null !== t.options.right.mode &&
            (n = t.options.right.mode),
          n
        );
      }
      function _(t, e) {
        ...
        return (
          e === p.EDITOR_LEFT &&
            null !== t.options.left.theme &&
            (n = t.options.left.theme),
          e === p.EDITOR_RIGHT &&
            null !== t.options.right.theme &&
            (n = t.options.right.theme),
          n
        );
      }
      d.prototype = {
        ...
        diff: function () {
          ...
          r.forEach(function (t, e, n) {
            ...
            n[e + 1] &&
              ...
              ((a += "\n"),
              (r[e][1] = a),
              (r[e + 1][1] = r[e + 1][1].replace(/^\n/, ""))),
              0 !== a.length &&
                (s === p.DIFF_EQUAL
                  ? ((o.left += a.length), (o.right += a.length))
                  : s === p.DIFF_DELETE
                  ? (i.push(S(this, p.DIFF_DELETE, o.left, o.right, a)),
                    (o.right += a.length))
                  : s === p.DIFF_INSERT &&
                    (i.push(S(this, p.DIFF_INSERT, o.left, o.right, a)),
                    (o.left += a.length)));
          }, this),
            (this.diffs = (function (t, e) {
              var n = [];
              function r(e) {
                return t.options.diffGranularity === p.DIFF_GRANULARITY_SPECIFIC
                  ? e < 1
                  : e <= 1;
              }
              e.forEach(function (t, e) {
                if (0 !== e) {
                  for (var i = !1, o = 0; o < n.length; o++)
                    if (
                      r(Math.abs(t.leftStartLine - n[o].leftEndLine)) &&
                      r(Math.abs(t.rightStartLine - n[o].rightEndLine))
                    ) {
                      (n[o].leftStartLine = Math.min(
                        t.leftStartLine,
                        n[o].leftStartLine
                      )),
                        (n[o].rightStartLine = Math.min(
                          t.rightStartLine,
                          n[o].rightStartLine
                        )),
                        (n[o].leftEndLine = Math.max(
                          t.leftEndLine,
                          n[o].leftEndLine
                        )),
                        (n[o].rightEndLine = Math.max(
                          t.rightEndLine,
                          n[o].rightEndLine
                        )),
                        (i = !0);
              ...
              return (
                n.forEach(function (t) {
                  (t.leftStartLine === t.leftEndLine &&
                    t.rightStartLine === t.rightEndLine) ||
                    i.push(t);
                }),
                i
              );
        ...
        destroy: function () {
          ...
          this.editors.right.ace.destroy(),
            ((n = (e = this.editors.right.ace.container).cloneNode(
              !1
            )).textContent = r),
      ...
      function x(t, e, n, r, i) {
        ...
        r--,
          e.markers.push(
            e.ace.session.addMarker(new g(n, 0, r, 1), o, "fullLine")
          );
      }
      function L(t, e, n) {
        var r, i, o;
      ...
      function w(t, e, n) {
        var r = { startLine: 0, startChar: 0, endLine: 0, endChar: 0 },
          i = e + n.length,
          o = 0,
          s = !1,
          a = !1;
        t.lineLengths.forEach(function (t, n) {
          (o += t),
            !s &&
              e < o &&
              ((r.startLine = n), (r.startChar = e - o + t), (s = !0)),
            !a &&
              i <= o &&
              ((r.endLine = n), (r.endChar = i - o + t), (a = !0));
        }),
          r.startChar > 0 &&
            M(t, r.startLine) === r.startChar &&
            (r.startLine++, (r.startChar = 0)),
      ...
      function C(t, e) {
        for (
          var n = t.ace.getSession().doc.getAllLines(), r = 0, i = 0, o = 0;
          o < n.length;
          o++
        )
          if (e <= (i += n[o].length + 1)) {
      ...
      function I(t, e, n) {
        for (
          var r = t.ace.getSession().doc.getAllLines(), i = 0, o = !1, s = 0;
          s < r.length;
          s++
        ) {
      ...
      function O(t) {
        (t.gutterHeight = document.getElementById(
          t.options.classes.gutterID
        ).clientHeight),
          (t.gutterWidth = document.getElementById(
            t.options.classes.gutterID
          ).clientWidth);
        ...
        (t.gutterSVG = document.createElementNS(p.SVG_NS, "svg")),
          ...
          document
            .getElementById(t.options.classes.gutterID)
            .appendChild(t.gutterSVG);
      }
      function A(t, e) {
        return (
          (e === p.EDITOR_LEFT ? t.editors.left : t.editors.right).ace
            .getSession()
            .getLength() * t.lineHeight
        );
      }
      function D(t) {
        var e, n;
        (e = t),
          ...
          t.diffs.forEach(function (t, e) {
            this.options.showDiffs &&
              ...
              this.options.showConnectors &&
                (function (t, e, n, r, i) {
                  var o = t.editors.left.ace.getSession().getScrollTop(),
                    s = t.editors.right.ace.getSession().getScrollTop();
                  t.connectorYOffset = 1;
                  var a = e * t.lineHeight - o + 0.5,
                    f = t.gutterWidth + 1,
                    l = r * t.lineHeight - s + 0.5,
                    h = n * t.lineHeight - o + t.connectorYOffset + 0.5,
                    u = t.gutterWidth + 1,
                    g = i * t.lineHeight - s + t.connectorYOffset + 0.5,
                    d =
                      (0, c.default)(-1, a, f, l) +
                      " L" +
                      f +
              ...
              (function (t, e, n) {
                ...
                e.rightEndLine > e.rightStartLine &&
                  t.options.right.copyLinkEnabled &&
                  ((r = T({
                    ...
                    diffIndex: n,
                    arrowContent:
                      t.options.classes.deletedCodeConnectorLinkContent,
                  })),
      ...
      t.exports = function t(e, n, c, l, h) {
        e !== n &&
          o(
            n,
            function (o, f) {
              if (a(o)) h || (h = new r()), s(e, n, f, c, t, l, h);
              else {
        ...
        return r(function (e, n) {
          ...
          for (
            s = t.length > 3 && "function" == typeof s ? (o--, s) : void 0,
              a && i(n[0], n[1], a) && ((s = o < 3 ? void 0 : s), (o = 1)),
              e = Object(e);
            ++r < o;
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n) {
        return (
          ...
          function () {
            for (
              var o = arguments, s = -1, a = i(o.length - e, 0), f = Array(a);
              ++s < a;
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n) {
        ...
        return (
          ...
          r(t, e, { leading: s, maxWait: e, trailing: a })
        );
      };
    },
    function (t, e, n) {
      ...
      r.Diff,
            ...
            switch (i[o][0]) {
              ...
              case 0:
                if (s >= 1 && a >= 1) {
                  ...
                  for (
                    var l, h = (l = this.diff_main(f, c, !1, n)).length - 1;
                    h >= 0;
                    h--
                  )
                    i.splice(o, 0, l[h]);
        ...
        (r.prototype.diff_bisect_ = function (t, e, n) {
          ...
          (f[s + 1] = 0), (c[s + 1] = 0);
          for (
            var h = r - i, u = h % 2 != 0, g = 0, p = 0, d = 0, v = 0, _ = 0;
            _ < o && !(new Date().getTime() > n);
            _++
          ) {
                  ...
                  S =
                    (L =
                      x == -_ || (x != _ && c[E - 1] < c[E + 1])
                        ? c[E + 1]
                        : c[E - 1] + 1) - x;
                L < r && S < i && t.charAt(r - L - 1) == e.charAt(i - S - 1);
            ...
            for (var e = "", i = 0, o = -1, s = n.length; o < t.length - 1; ) {
              ...
              (i = o + 1),
                (r.hasOwnProperty ? r.hasOwnProperty(a) : void 0 !== r[a])
                  ...
                  : ((e += String.fromCharCode(s)), (r[a] = s), (n[s++] = a));
            }
            return e;
          }
        ...
        (r.prototype.diff_commonOverlap_ = function (t, e) {
          ...
          for (var o = 0, s = 1; ; ) {
            ...
            if (-1 == f) return o;
            (s += f),
              (0 != f && t.substring(i - s) != e.substring(0, s)) ||
                ((o = s), s++);
          }
        }),
        (r.prototype.diff_halfMatch_ = function (t, e) {
          ...
          function o(t, e, n) {
            for (
              ...
              l.length < u + h &&
                ((l = e.substring(c - u, c) + e.substring(c, c + h)),
                (r = t.substring(0, n - u)),
                (o = t.substring(n + h)),
                (s = e.substring(0, c - u)),
                (a = e.substring(c + h)));
          ...
          return h || u
            ? ((s = u ? (h && h[4].length > u[4].length ? h : u) : h),
              t.length > e.length
                ? ((a = s[0]), (f = s[1]), (c = s[2]), (l = s[3]))
                : ((c = s[0]), (l = s[1]), (a = s[2]), (f = s[3])),
              [a, f, c, l, s[4]])
            : null;
        }),
        (r.prototype.diff_cleanupSemantic = function (t) {
          for (
            ...
            0 == t[o][0]
              ? ((n[r++] = o),
                ...
                (c = 0),
                (i = t[o][1]))
              : (1 == t[o][0] ? (f += t[o][1].length) : (c += t[o][1].length),
                i &&
                  i.length <= Math.max(s, a) &&
                  i.length <= Math.max(f, c) &&
          ...
          for (
            ...
            if (-1 == t[o - 1][0] && 1 == t[o][0]) {
              ...
              u >= g
                ? (u >= l.length / 2 || u >= h.length / 2) &&
                  (t.splice(o, 0, [0, h.substring(0, u)]),
                  (t[o - 1][1] = l.substring(0, l.length - u)),
                  (t[o + 1][1] = h.substring(u)),
                  o++)
                : (g >= l.length / 2 || g >= h.length / 2) &&
                  (t.splice(o, 0, [0, l.substring(0, g)]),
                  (t[o - 1][0] = 1),
                  (t[o - 1][1] = h.substring(0, h.length - g)),
                  (t[o + 1][0] = -1),
                  (t[o + 1][1] = l.substring(g)),
                  o++),
                o++;
            }
            o++;
        ...
        (r.prototype.diff_cleanupEfficiency = function (t) {
          for (
            ...
            0 == t[o][0]
              ? (t[o][1].length < this.Diff_EditCost && (f || c)
                  ? ((n[r++] = o), (s = f), (a = c), (i = t[o][1]))
                  : ((r = 0), (i = null)),
                (f = c = !1))
              : (-1 == t[o][0] ? (c = !0) : (f = !0),
                i &&
            ...
            switch (t[n][0]) {
              ...
              case 0:
                r + i > 1
                  ? (0 !== r &&
                      0 !== i &&
                      (0 !== (e = this.diff_commonPrefix(s, o)) &&
                        (n - r - i > 0 && 0 == t[n - r - i - 1][0]
                          ? (t[n - r - i - 1][1] += s.substring(0, e))
                          : (t.splice(0, 0, [0, s.substring(0, e)]), n++),
                        (s = s.substring(e)),
                        (o = o.substring(e))),
                      0 !== (e = this.diff_commonSuffix(s, o)) &&
                        ((t[n][1] = s.substring(s.length - e) + t[n][1]),
                        (s = s.substring(0, s.length - e)),
                        (o = o.substring(0, o.length - e)))),
                    0 === r
                      ? t.splice(n - i, r + i, [1, s])
                      : 0 === i
                      ? t.splice(n - r, r + i, [-1, o])
                      : t.splice(n - r - i, r + i, [-1, o], [1, s]),
        ...
        (r.prototype.patch_make = function (t, e, n) {
          ...
          if ("string" == typeof t && "string" == typeof e && void 0 === n)
            (i = t),
              (o = this.diff_main(i, e, !0)).length > 2 &&
          ...
          for (
            ...
            switch ((f || 0 === p || ((a.start1 = c), (a.start2 = l)), p)) {
              ...
              case -1:
                ...
                break;
              case 0:
                d.length <= 2 * this.Patch_Margin && f && o.length != g + 1
                  ? ((a.diffs[f++] = o[g]),
                    (a.length1 += d.length),
                    (a.length2 += d.length))
          ...
          for (var r = 0, i = [], o = 0; o < t.length; o++) {
            ...
            if (
                ...
                ? -1 !=
                  ...
                  (-1 ==
                    (l = this.match_main(
                      ...
                      f + c.length - this.Match_MaxBits
                    )) ||
                    s >= l) &&
                  (s = -1)
                : (s = this.match_main(e, c, f)),
              -1 == s)
            )
              ...
              c ==
                (a =
                  -1 == l
                    ? e.substring(s, s + c.length)
                    : e.substring(s, l + this.Match_MaxBits)))
            )
              e =
                e.substring(0, s) +
                this.diff_text2(t[o].diffs) +
                e.substring(s + c.length);
            else {
              var h = this.diff_main(c, a, !1);
              if (
                c.length > this.Match_MaxBits &&
                this.diff_levenshtein(h) / c.length > this.Patch_DeleteThreshold
              )
                i[o] = !1;
              else {
                ...
                for (var u, g = 0, p = 0; p < t[o].diffs.length; p++) {
                  ...
                  0 !== d[0] && (u = this.diff_xIndex(h, g)),
                    1 === d[0]
                      ? (e = e.substring(0, s + u) + d[1] + e.substring(s + u))
                      : -1 === d[0] &&
                        (e =
                          e.substring(0, s + u) +
                          e.substring(
                            s + this.diff_xIndex(h, g + d[1].length)
                          )),
                    -1 !== d[0] && (g += d[1].length);
                }
              }
              ...
              for (
                ...
                for (
                  f.start1 = o - a.length,
                    f.start2 = s - a.length,
                    "" !== a &&
                      ((f.length1 = f.length2 = a.length),
                      f.diffs.push([0, a]));
                  0 !== i.diffs.length && f.length1 < e - this.Patch_Margin;
                  ...
                  1 === l
                    ...
                    ? ((f.length1 += h.length),
                      ...
                      f.diffs.push([l, h]),
                      i.diffs.shift())
                    : ((h = h.substring(0, e - f.length1 - this.Patch_Margin)),
                      (f.length1 += h.length),
                      (o += h.length),
                      0 === l
                        ? ((f.length2 += h.length), (s += h.length))
                        : (c = !1),
                      f.diffs.push([l, h]),
                      h == i.diffs[0][1]
                        ? i.diffs.shift()
                        : (i.diffs[0][1] = i.diffs[0][1].substring(h.length)));
                }
                a = (a = this.diff_text2(f.diffs)).substring(
                  a.length - this.Patch_Margin
                );
                var u = this.diff_text1(i.diffs).substring(
                  0,
                  this.Patch_Margin
                );
                "" !== u &&

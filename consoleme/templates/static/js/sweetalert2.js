!(function (t, e) {
  ...
  function z() {
    return H(k["progress-steps"]);
  }
  function W() {
    return H(k["validation-message"]);
  }
  function K() {
    return I("." + k.actions + " ." + k.confirm);
  }
  function F() {
    return I("." + k.actions + " ." + k.cancel);
  }
  function Z() {
    return H(k.actions);
  }
  ...
  function G(t) {
    ue.isVisible() && et !== t.target.value && ue.resetValidationMessage(),
      (et = t.target.value);
  }
  function tt(t, e) {
      ...
      (function (t, e) {
        ...
        if (n && e.type === n.type && D()) b(D(), e.customClass, "icon");
          ...
          if ((St(), -1 !== Object.keys(B).indexOf(e.type))) {
            var o = I(".".concat(k.icon, ".").concat(B[e.type]));
            O(o),
  ...
  function Zt(t, e, n) {
    t.removeEventListener(dt, Zt), S(t, k.hide) && Ft(e, n);
  }
  function Qt(t) {
    var e = q(),
      n = rt(),
    ...
    n &&
      ...
      ot(n, k.show),
      nt(n, k.hide),
      dt && j(n) ? n.addEventListener(dt, Zt.bind(null, n, e, a)) : Ft(e, a),
      i(t || {}));
  }
  var Yt = function (t) {
    null !== t &&
  ...
  function te(t, e) {
    t.removeEventListener(dt, te), (e.style.overflowY = "auto");
  }
  function ee(t) {
    var e = q(),
      n = rt();
    null !== t.onBeforeOpen &&
      ...
      dt && j(n)
        ? ((e.style.overflowY = "hidden"),
          n.addEventListener(dt, te.bind(null, n, e)))
        ...
        return new Promise(function (t) {
          ...
          l.reverseButtons
            ...
            l.toast ||
              ...
              (Ot.keydownTarget = l.keydownListenerCapture ? window : d.popup),
              (Ot.keydownListenerCapture = l.keydownListenerCapture),
              Ot.keydownTarget.addEventListener("keydown", Ot.keydownHandler, {
                capture: Ot.keydownListenerCapture,
              }),

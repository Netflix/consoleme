...
import {
  Button, Dimmer, Loader, Form, Grid, Header, Message, Search, Segment, Icon, Radio, Feed,
...
const clone_default_selected_options = clone_options.map((option) => option.value);
...
class CreateCloneFeature extends Component {
    ...
    render() {
      const {
        isLoading, isLoadingAccount, results, source_role_value, dest_account_id_value, dest_role_name, resultsAccount,
        description, messages, requestSent, requestResults, options,
        isSubmitting, roleCreated, dest_account_id, copy_description, feature_type,
      } = this.state;
                ...
                <Grid.Column>
                  ...
                  <Form>
                    ...
                    <Form.Input
                      ...
                      onChange={this.handleChange}
                      disabled={copy_description === true && feature_type === 'clone'}
                    />
                  </Form>
                </Grid.Column>
              </Grid.Row>

...
import {
  Button, Dimmer, Divider, Form, Grid, Header, Label, Loader, Message, Tab, Table, TextArea,
    ...
    const tabContent = (isSuccess)
      ? (
        <Message positive>
          ...
          You can check your request status from <a
      ...
      : (
        <>
          <Tab
            onTabChange={(event, data) => this.setState({

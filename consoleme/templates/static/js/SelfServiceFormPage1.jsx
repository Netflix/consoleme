    ...
    <div>
      ...
      <div className="field" style={{ width: "100%" }}>
        <label style={{ width: "100%" }}>
          Search for your application and select an account to fill in your role
          identifier:
        </label>
        <div>
          <Field
...
const SelfServiceFormPage1 = (props) => {
  ...
  return (
    <Form onSubmit={handleSubmit} className="ui form">
      ...
      <div>
        <label>
          <b>Temporary Policy</b>
        </label>
        <p>
          Temporary policies will automatically be removed on the specified
          date.
        </p>
        <div>
          <div>
      ...
      <div>
        <button
          type="cancel"
          className="ui negative button cancel"
          onClick={cancelRequest}
          style={{ margin: "10px", display: cancelButtonDisplayed }}
        >
          Cancel
        </button>
        <button

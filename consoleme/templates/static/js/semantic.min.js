              ...
              get: {
                ...
                prompt: function (t, n) {
                  ...
                  return (
                    ...
                    d &&
                      ((o =
                        1 == (i = s.closest(x.group).find("label").eq(0)).length
                          ? i.text()
                ...
                field: function (e) {
                  return (
                    ...
                    m.filter("#" + e).length > 0 ||
                      ...
                      m.filter("[data-" + y.validate + '="' + e + '"]').length >
                        0
                  );
                },
              },
              ...
              create: {
                label: function () {
                  S.prevAll(v.label).length > 0
                    ? (S.prev(v.label).detach().insertAfter(S),
              ...
              queryRemote: function (t, n) {
                var i = {
                  ...
                  onSuccess: function (e) {
                    S.remove.message(),
                      S.setup.menu({ values: e[R.remoteValues] }),
                      n();
                  },
                };
                      ...
                      t == P.leftArrow
                        ? (!f && !m) || r
                          ? r &&
                            ...
                            l && !s
                              ? i.addClass(T.active)
                              : i.prev(D.siblingLabel).addClass(T.active).end(),
                            e.preventDefault())
                          : (S.verbose("Selecting previous label"),
          ...
          e(this).each(function () {
            ...
            (m = {
              ...
              create: {
                ...
                results: function () {
                  0 === R.length &&
                    (R = e("<div />").addClass(p.results).appendTo(k));
                },
              },
              inject: {

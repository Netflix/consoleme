...
#   timestamp: 2021-05-26T04:06:34+00:00
...
class AwsIamRolePrincipalModel(PrincipalModel):
    principal_type: constr(regex=r"AwsIamRole")
...
class HoneybeeAwsIamRoleTemplatePrincipalModel(PrincipalModel):
    principal_type: constr(regex=r"HoneybeeAwsIamRoleTemplate")
...
class ChangeGeneratorModel(BaseModel):
    principal: Optional[
        Union[AwsIamRolePrincipalModel, HoneybeeAwsIamRoleTemplatePrincipalModel]
    ] = None

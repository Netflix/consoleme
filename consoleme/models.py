...
#   timestamp: 2020-09-08T22:53:33+00:00
...
class ActionGroup4(Enum):
    send_email = "send_email"


class SESChangeGeneratorModel(ChangeGeneratorModel):
    from_address: str
    action_groups: Optional[List[ActionGroup4]] = None
...
class ManagedPolicyChangeModel(ChangeModel):
    ...
    policy_name: str
    change_type: Optional[ChangeType2] = None
    action: Action1
...
class ChangeRequestStatusodificationModel(RequestModificationBaseModel):
    pass
...
class InlinePolicyChangeModel(ChangeModel):
    ...
    change_type: Optional[ChangeType1] = None

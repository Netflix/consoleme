...
from consoleme.handlers.v2.audit import AuditRolesAccessHandler, AuditRolesHandler, AuditRolesByAccountHandler, AuditRolesByNameHandler
...
def make_app(jwt_validator=None):
    ...
    oss_routes = [
        ...
        (r"/api/v2/audit/roles/account/(\d{12})", AuditRolesByAccountHandler),
        (r"/api/v2/audit/roles/account/(.*)", AuditRolesByNameHandler),

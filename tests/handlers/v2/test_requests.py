...
class TestRequestsHandler(AsyncHTTPTestCase):
    ...
    def test_post_new_managed_policy_resource_request_autoapprove(self):
        ...
        self.assertEqual(
            result,
            {'errors': 0, 'request_created': True, 'action_results': [{'status': 'success', 'message': 'Successfully created managed policy arn:aws:iam::123456789012:policy/randompath/extra/testpolicy'}, {'status': 'success', 'message': 'Successfully updated change in dynamo'}, {'status': 'success', 'message': 'Successfully updated request status'}], 'extended_request': {'request_url': None, 'principal': {'principal_type': 'AwsResource', 'principal_arn': 'arn:aws:iam::123456789012:policy/randompath/extra/testpolicy'}, 'justification': None, 'requester_email': 'consoleme_admins@example.com', 'approvers': [], 'request_status': 'approved', 'cross_account': False, 'arn_url': '/policies/edit/123456789012/managed_policy/randompath/extra/testpolicy', 'admin_auto_approve': True, 'changes': {'changes': [{'principal': {'principal_type': 'AwsResource', 'principal_arn': 'arn:aws:iam::123456789012:policy/randompath/extra/testpolicy'}, 'change_type': 'managed_policy_resource', 'resources': [], 'version': '3.0', 'status': 'not_applied', 'autogenerated': False, 'updated_by': None, 'expiration_date': None, 'new': True, 'policy': {'version': None, 'policy_document': {'Version': '2012-10-17', 'Statement': [{'Action': ['s3:GetObjectVersionTagging', 's3:GetObjectAcl', 's3:ListBucket', 's3:GetObject', 's3:GetObjectVersionAcl', 's3:GetObjectTagging', 's3:GetObjectVersion', 's3:ListBucketVersions'], 'Effect': 'Allow', 'Resource': ['arn:aws:s3:::12345', 'arn:aws:s3:::12345/*']}]}, 'policy_sha256': None}, 'old_policy': None}]}, 'requester_info': {'email': 'consoleme_admins@example.com', 'extended_info': {'domain': '', 'userName': 'consoleme_admins@example.com', 'name': {'givenName': '', 'familyName': '', 'fullName': ''}, 'primaryEmail': 'consoleme_admins@example.com'}, 'details_url': None, 'photo_url': 'https://www.gravatar.com/avatar/ec2ee26a6397f686011678e50aeb4e81?d=mp'}, 'reviewer': 'consoleme_admins@example.com'}}
        )

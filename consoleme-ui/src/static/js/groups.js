$(document).ready(function () {
  ...
  $('#groups thead th').each(function () {
    ...
    if (title == "Access") {
      $(this).html('<select id="request_select"><option value="all">All</option><option value="requestable">Requestable groups</option><option value="member">Groups I\'m a memeber of</option><option value="not_member">Groups I\'m not a member of</option></select>');
    } else {
    ...
    "columns": [
      {
        ...
        "render": function (data, type, row, meta) {
          if (type === 'display') {
            data = '<a target="_blank" href="/accessui/group/' + data + '">' + data + '</a>';
          }

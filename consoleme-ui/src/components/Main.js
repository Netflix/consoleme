...
class ConsoleMeMain extends Component {
    ...
    createEligibleRoleLists() {
        const filteredRoles = this.state.selectedAccount
            ? _.filter(this.state.eligibleRoles, (role) => role.account == this.state.selectedAccount)
                ...
                >
                    ...
                    >
                        <List.Header>
                            <Label
                                as="a"
                                color={userRole.perUserRole ? "orange" : "blue"}
                            >
                                <Icon name="sign-in" />
    ...
    render() {
        const {isLoading, searchLoading, searchValue, searchResults, selectedRole} = this.state;
                                    ...
                                    <Grid columns={1} relaxed='very'>
                                        <Grid.Column>
                                            ...
                                            <div>
                                                ...
                                                {
                                                    selectedRole.role
                                                        ? <a href="#">{selectedRole.userRole.roleName + ".json"}</a>
                                                        : null
                                                }
                                            </div>
                                            <br />
                                            <div>
                                                ...
                                                <br />
                                                {
                                                    selectedRole.userRole.perUserRole != null
                                                        ? selectedRole.userRole.perUserRole ? "enabled" : "disabled"
                                                        : null
                                                }
                                            </div>
                                            <br />
                                            <div>
                                                ...
                                                <br />
                                                {
                                                    selectedRole.arn
                                                        ?
                                                        <Label>
                                                            newt --app-type awscreds refresh -r {selectedRole.arn}
                                                        </Label>
                                                        : null
                                                }
                                            </div>

  ...
  <Feed>
    <Feed.Event>
      ...
      <Feed.Content>
        ...
        <Feed.Summary>
          Target S3 bucket exists in the cross account. You need to assume a role in the cross account using
          your <a>{props.source}</a> role.
        </Feed.Summary>
        <Feed.Extra text>
    ...
    <Feed.Event>
      ...
      <Feed.Content>
        <Feed.Date>Denied</Feed.Date>
        <Feed.Summary>
          The bucket policy is required to allow your role to access the S3 bucket <a>{props.target}</a> exists in the
          cross account.
        </Feed.Summary>
        <Feed.Extra text>
          Please reach out to #security-help for further requests with this details.
    ...
    <Feed.Event>
      ...
      <Feed.Content>
        ...
        <Feed.Summary>
          Your role <a>{props.source}</a> already has all the desired permissions
          for <b>GET</b>, <b>PUT</b> and <b>LIST</b> the bucket <a>{props.target}</a>.
        </Feed.Summary>
      </Feed.Content>
    </Feed.Event>
    <Feed.Event>
...
class SelfService extends Component {
  ...
  render() {
    const {isLoading, isLoadingTarget, sourceValue, targetValue, results, targetResults, eligibleRoles, sourceType, targetType} = this.state;
      ...
      case "s3":
        targetServiceSubInput = (<div>
          ...
          <Form.Field>
            ...
            <Form.Checkbox label='LIST Objects' onChange={this.handleInputChange}/>
            <Form.Checkbox label='GET Objects' onChange={this.handleInputChange}/>

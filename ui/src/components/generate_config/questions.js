...
export const questions_json = {
  ...
  questions: [
    ...
    },
    {
      ...
      isRequired: true,
      name: "account_ids_to_name_PLACEHOLDER_2",
      title:
    ...
    },
    {
      isRequired: true,
      name:
        "cache_accounts_from_aws_organizations.organizations_master_account_id_PLACEHOLDER_3",
      title:
    ...
    },
    {
      isRequired: true,
      name:
        "cache_accounts_from_aws_organizations.organizations_master_role_to_assume_PLACEHOLDER_4",
      title:
    ...
    {
      isRequired: true,
      name: "retrieve_accounts_from_swag.base_url_PLACEHOLDER_5",
      title:
    ...
    },
    {
      ...
      isRequired: true,
      name: "policies.role_name_PLACEHOLDER_6",
      title:
    ...
    {
      isRequired: true,
      name: "auth.user_header_name_PLACEHOLDER_7",
      title:
    ...
    {
      isRequired: true,
      name: "auth.groups_header_name_PLACEHOLDER_8",
      title:
    ...
    },
    {
      isRequired: true,
      name:
        "get_user_by_aws_alb_auth_settings.access_token_validation.metadata_url_PLACEHOLDER_9",
      title:
    ...
    },
    {
      ...
      name:
        "get_user_by_aws_alb_auth_settings.access_token_validation.jwks_uri_PLACEHOLDER_10",
      title:
    ...
    },
    {
      ...
      isRequired: true,
      name: "get_user_by_aws_alb_auth_settings.jwt_groups_key_PLACEHOLDER_11",
    ...
    },
    {
      ...
      isRequired: true,
      name:
        "get_user_by_aws_alb_auth_settings.access_token_validation.metadata_url_PLACEHOLDER_12",
    ...
    },
    {
      __extra_details: "list",
      name:
        "get_user_by_aws_alb_auth_settings.access_token_validation.jwks_uri_PLACEHOLDER_13",
      title:
        "Please provide a comma-seperated list of jwks_uri (Only required if your metadata URL doesn't return jwks_uri within the JSON)",
      type: "text",
      visibleIf: "{__auth_choice} = 'ALB Auth - Google'",
    },
    {
      isRequired: true,
      name:
        "get_user_by_aws_alb_auth_settings.access_token_validation.metadata_url_PLACEHOLDER_14",
      title:
    ...
    },
    {
      __extra_details: "list",
      name:
        "get_user_by_aws_alb_auth_settings.access_token_validation.jwks_uri_PLACEHOLDER_15",
      title:
        "Please provide a comma-seperated list of jwks_uri (Only required if your metadata URL doesn't return jwks_uri within the JSON)",
      type: "text",
      visibleIf: "{__auth_choice} = 'ALB Auth - Okta'",
    },
    {
      isRequired: true,
      name:
        "get_user_by_aws_alb_auth_settings.access_token_validation.client_id_PLACEHOLDER_16",
    ...
    },
    {
      isRequired: true,
      name:
        "get_user_by_aws_alb_auth_settings.access_token_validation.metadata_url_PLACEHOLDER_17",
      title:
    ...
    },
    {
      defaultValue: "email",
      isRequired: true,
      name: "get_user_by_aws_alb_auth_settings.jwt_email_key_PLACEHOLDER_18",
    ...
    },
    {
      defaultValue: "groups",
      isRequired: true,
      name: "get_user_by_aws_alb_auth_settings.jwt_groups_key_PLACEHOLDER_19",
      title: "What should the value be for jwt_groups_key (jwt_groups_key)?",
      type: "text",
      visibleIf:
    ...
    {
      isRequired: true,
      name: "get_user_by_oidc_settings.metadata_url_PLACEHOLDER_20",
      title:
    ...
    },
    {
      defaultValue: "email",
      isRequired: true,
      name: "get_user_by_oidc_settings.jwt_email_key_PLACEHOLDER_21",
      title:
    ...
    },
    {
      defaultValue: "groups",
      isRequired: true,
      name: "get_user_by_oidc_settings.jwt_groups_key_PLACEHOLDER_22",
      title:
    ...
    },
    {
      defaultValue: true,
      name:
        "get_user_by_oidc_settings.get_groups_from_userinfo_endpoint_PLACEHOLDER_23",
      title:
    ...
    {
      isRequired: true,
      name: "get_user_by_oidc_settings.user_info_groups_key_PLACEHOLDER_24",
      title:
      ...
      type: "text",
      visibleIf:
        "{get_user_by_oidc_settings.get_groups_from_userinfo_endpoint_PLACEHOLDER_23} = 'True'",
    },
    {
      isRequired: true,
      name: "consoleme_s3_bucket_PLACEHOLDER_25",
      title:
    ...
    },
    {
      ...
      name: "redis.host.global_PLACEHOLDER_26",
      title:
    ...
    {
      defaultValue: "redis://{redis.host.global_PLACEHOLDER_26}:6379/1",
      name: "celery.broker.global_PLACEHOLDER_27",
      title:
    ...
    {
      defaultValue: "redis://{redis.host.global_PLACEHOLDER_26}:6379/2",
      name: "celery.broker.global_PLACEHOLDER_28",
      title:
    ...
    },
    {
      ...
      name: "celery.active_region_PLACEHOLDER_29",
      title:
    ...
    {
      defaultValue: true,
      name: "challenge_url.enabled_PLACEHOLDER_30",
      title:
    ...
    },
    {
      defaultValue: "us-west-2",
      isRequired: true,
      name: "ses.region_PLACEHOLDER_32",
      title:
    ...
    },
    {
      ...
      inputType: "email",
      isRequired: true,
      name: "ses.consoleme.sender_PLACEHOLDER_33",
      title:
    ...
    },
    {
      autoComplete: "email",
      inputType: "email",
      name: "support_contact_PLACEHOLDER_34",
      title:
    ...
    },
    {
      ...
      name: "support_chat_url_PLACEHOLDER_35",
      title:
    ...
    {
      defaultValue:
        "Please contact us at {support_contact_PLACEHOLDER_34} if you have any questions or concerns.",
      name: "ses.support_reference_PLACEHOLDER_36",
      title:
    ...
    },
    {
      ...
      name: "documentation_page_PLACEHOLDER_37",
      title:
    ...
    },
    {
      ...
      name:
        "cloud_credential_authorization_mapping.role_tags.authorized_groups_tags_PLACEHOLDER_38",
      title:
    ...
    },
    {
      ...
      name:
        "cloud_credential_authorization_mapping.role_tags.authorized_groups_cli_only_tags_PLACEHOLDER_39",
      title:

            ...
            <Grid relaxed="very">
              ...
              <Grid.Row>
                <Grid.Column width={8}>
                  ...
                  <Label circular>{role.number_of_accounts}</Label> Affected
                  Accounts
                </Grid.Column>
                <Grid.Column width={8}>
                  <Header as="h5">
              ...
              {includeExcludeAccounts.length > 0 ? (
                <Grid.Row>
                  <Grid.Column width={16}>
                    <Header as="h5">ACCOUNTS</Header>
                    <Table basic="very" compact="very" striped size="small">
                      <Table.Header>
                        <Table.Row>
              ...
              <Grid.Row>
                <Grid.Column width={16}>
                  ...
                  <Table basic="very" compact="very" striped size="small">
                    <Table.Header>
                      <Table.Row>
                        <Table.HeaderCell width={8}>KEY</Table.HeaderCell>

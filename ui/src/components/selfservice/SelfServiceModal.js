...
import {Button, Divider, Form, Grid, GridColumn, Header, Message, Modal, TextArea} from 'semantic-ui-react'
    ...
    return (
       ...
       >
         ...
         <Message info>
           ...
           <p>Helpful text about how to use the Advanced Editor, JSON syntax, etc.</p>
         </Message>
         <Modal.Content>
           {jsonEditor}
           <Divider/>

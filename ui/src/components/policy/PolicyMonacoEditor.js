...
export const PolicyMonacoEditor = (props) => {
    ...
    const [policyDocument, setPolicyDocument] = useState(JSON.stringify(policy.PolicyDocument, null, "\t"));
...
export const NewPolicyMonacoEditor = (props) => {
    ...
    const [policyDocument, setPolicyDocument] = useState(JSON.stringify(JSON.parse(templateOptions[0].value), null, "\t"));
